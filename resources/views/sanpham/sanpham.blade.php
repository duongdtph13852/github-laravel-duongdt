                    ...
                    <table class="table table-bordered">
                        <tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center">{{$u->prod_id}}</td>
                                <td class="text-center"><a style="color:#333333;font-weight: bold;" href="/sanpham/detail/{{$u->prod_id}}" style="white-space:unset;text-align: justify;">{{$u->name}}<i class="fa fa-edit"></i></a></td>
                                ...
                                <td class="text-center"><a href="/sanpham/delete/{{$u->prod_id}}">xóa</a></td>
                                </tr>
                                @endforeach
